...
export default function AdminScholarsPage() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="font-display text-3xl font-bold text-primary">Scholars</h1>
      ...
      {loading ? (
        ...
        <div className="text-center py-16 text-muted">
          <FiUser className="mx-auto text-4xl mb-3 text-secondary" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {scholars.map((scholar) => (
            <div
              key={scholar.id}
              className="glass-card rounded-xl p-5 border border-theme hover:border-theme transition-colors"
            >
              <div className="flex items-start justify-between mb-3">
                ...
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger asChild>
                    <button className="p-1.5 text-muted hover:text-primary rounded-lg">
                    ...
                    >
                      <DropdownMenu.Item asChild>
                        <Link
                          ...
                          className="flex items-center gap-2 px-3 py-2 text-sm text-muted hover:text-primary hover:bg-card-hover rounded-lg cursor-pointer"
                        >
                      ...
                      >
                        <FiStar
                          size={12}
                          className={scholar.featured ? "text-accent" : ""}
                        />
              ...
              {scholar.featured && (
                <div className="flex items-center gap-1 mb-2">
                  <FiStar className="text-accent" size={11} />
              ...
              <div className="flex flex-wrap gap-1">
                {scholar.topics.slice(0, 3).map((t) => (
                  <span
                    key={t}
                    className="text-xs px-2 py-0.5 rounded-full bg-accent/20 text-accent border border-accent/20"
                  >
                    {t}
                  </span>
                ))}
