...
interface Props {
  /** Official platform admin email — passed from the server component */
  adminEmail: string;
}

export function ContactForm({ adminEmail }: Props) {
      ...
      <div className="bg-[var(--bg-secondary)] border-b border-[var(--border)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
          ...
          <p className="text-sm text-[var(--text-muted)] max-w-md mx-auto leading-relaxed">
            Have a question, a suggestion, or need help? Fill in the form below and we&apos;ll respond within 1–2 business days.
          </p>
        </div>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 p-4 glass-card rounded-xl border border-[var(--border)]">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--text-muted)] mt-0.5">1–2 business days</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={(e) => void handleSubmit(e)} className="glass-card rounded-2xl p-6 sm:p-8 border border-[var(--border)] space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-9 pr-3 py-3 bg-[var(--bg-elevated)] border border-[var(--border-strong)] rounded-xl text-sm text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] transition-colors"
                      />
                    </div>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 bg-[var(--bg-elevated)] border border-[var(--border-strong)] rounded-xl text-sm text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] transition-colors resize-none"
                  />
