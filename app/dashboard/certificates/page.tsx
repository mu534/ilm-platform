...
import { FiAward, FiDownload, FiCompass, FiShield, FiAlertTriangle } from "react-icons/fi";
          ...
          {certificates.map((cert) => (
            <div
              ...
              className={`glass-card rounded-2xl p-6 border ${
                cert.isRevoked ? "border-red-500/40" : "border-[var(--border-strong)]"
              } hover:shadow-lg transition-all duration-300 relative overflow-hidden flex flex-col justify-between`}
            >
              <div
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  {cert.isRevoked ? (
                    <span className="text-[10px] font-semibold text-red-400 bg-red-500/10 border border-red-500/20 px-2.5 py-1 rounded-full flex items-center gap-1">
                      <FiAlertTriangle size={11} /> Revoked
                    </span>
                  ) : (
              ...
              <div className="pt-4 mt-4 border-t border-[var(--border)] flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <Link
                    ...
                    className="btn-secondary px-3 py-1.5 text-xs font-medium rounded-xl inline-flex items-center gap-1 text-[var(--accent)]"
                  >
                  ...
                  <a
                    ...
                    className="btn-secondary px-3 py-1.5 text-xs font-semibold rounded-xl inline-flex items-center gap-1.5"
                  >
