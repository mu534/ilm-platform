...
export function CategoryExplorer({ categories }: CategoryExplorerProps) {
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 border-t border-[var(--border)] animate-fadeInUp">
      <div className="flex items-end justify-between mb-8 gap-4">
        <div>
          ...
          <h2 className="font-display text-2xl sm:text-3xl font-semibold text-[var(--text-primary)]">
            Explore Every Field of Knowledge
          </h2>
        </div>
        <Link
          href="/courses"
